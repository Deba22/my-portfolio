...
function Footer() {
    return (
        <footer>
            <div class="container">
                <Link to="navbar" smooth={true}><a href="" aria-label="Back To Top" class="backToTop"><svg class="svg-inline--fa fa-chevron-up fa-w-14" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-up" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M240.971 130.524l194.343 194.343c9.373 9.373 9.373 24.569 0 33.941l-22.667 22.667c-9.357 9.357-24.522 9.375-33.901.04L224 227.495 69.255 381.516c-9.379 9.335-24.544 9.317-33.901-.04l-22.667-22.667c-9.373-9.373-9.373-24.569 0-33.941L207.03 130.525c9.372-9.373 24.568-9.373 33.941-.001z"></path></svg></a></Link>
                <div class="footer-inner">
                    ...
                    <span class="nav-social">
                        <a href="https://github.com/santdas36" rel="noreferrer" target="_blank" aria-label="Github">
                            <svg class="svg-inline--fa fa-github fa-w-16 fa-fw" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="github" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" data-fa-i2svg="">
                        ...
                        <a href="https://www.linkedin.com/in/santdas36" rel="noreferrer" target="_blank" aria-label="LinkedIn">
