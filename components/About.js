    ...
    return (
        <section id="about">
            <div className="about__container">
                ...
                <div className="about-who">
                    ...
                    <div className="hero-content">
                        ...
                        <p className="phonetics">
                            <span className="lighter">(n.) /dhɑːs sʌnθəʊʃ/</span>
                        ...
                        <p className="description"><span className="lighter">defn.</span> a male of South Indian descent, who once happened to click on 'View Source' of a webpage with genuine curiosity, and now is a <b>Front-End Developer</b> and <b>UI/UX Designer</b> <a href="#work" className="lighter"><small>[more]</small></a></p>
                        <a className="cta magnet" href="#contact">
                            Say "Hi"
                ...
                <h3 className="heading">What Do I Do?</h3>
                ...
                <div className="services">
                    <div className="service" >
                        ...
                        <p>Starting from single page landing sites to e-commerce sites, I help you visualize what you think, in the form of full-fledged websites and design prototypes.</p>
                    </div>
