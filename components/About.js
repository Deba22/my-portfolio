...
function About() {
  const [playlist, setplaylist] = useState([
    require('../public/audio/holdmedown.mp3'),
    require('../public/audio/radioactive.mp3'),
    require('../public/audio/chlorine.mp3'),
    require('../public/audio/clementine.mp3'),
    require('../public/audio/whatever.mp3'),
    require('../public/audio/thunder.mp3'),
    require('../public/audio/yesterday.mp3')
  ]);
      ...
      <div className="about__container">
        ...
        <div className="about-who">
          ...
          <div className="hero-content">
            ...
            <p className="description"><span className="lighter">defn.</span> 
            <a className="description-link" href='https://community.umbraco.com/mvp-program/current-mvps/' target='_blank'>Umbraco MVP</a> and <a className="description-link" href='https://umbraco.com/training/certified-developers/developer/?uid=41457' target='_blank'>Umbraco certified master</a> living in the most scenic Indian state of Goa, whose passion is creating digital solutions to solve real world problems. Currently working at Brace Digital as an Umbraco Developer.
            </p>
                       
            <button onClick={() => scrollToSection("contact")} className="cta magnet">
              Say "Hi"
