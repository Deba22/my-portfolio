            ...
            <div className="about__container">
                ...
                <div className="about-who">
                    ...
                    <div className="hero-content">
                        ...
                        <p className="description"><span className="lighter">defn.</span> Umbraco certified software developer living in the most scenic Indian state of Goa, who's passion is creating digital solutions to solve real world problems. Currently working at ClerksWell as a developer.<Link to="work" smooth={true} className="lighter"><small>[more]</small></Link></p>
